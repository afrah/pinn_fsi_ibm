...
class BaseTrainer:
    ...
    def get_random_minibatch(self, dataset_length, batch_size=0):
        if batch_size == 0:
    ...
    def _save_checkpoint(self, epoch):
        ...
        state = {
            ...
            "epoch": epoch,
            "fluid_data_mean": self.train_dataloader.fluid_data.min_x,
            "fluid_data_std": self.train_dataloader.fluid_data.max_x,
            "solid_data_mean": self.train_dataloader.solid_data.min_x,
            "solid_data_std": self.train_dataloader.solid_data.max_x,
            "config": self.config,
