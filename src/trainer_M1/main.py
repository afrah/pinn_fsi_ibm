...
def main(config):
    ...
    if config.get("problem") == "fsi":
        if config.get("weighting") == "Fixed":
            from src.trainer_M1 import ibm_trainer_Fixed
            ...
            from src.trainer_M1 import ibm_trainer_RBA
            ...
            from src.trainer_M1 import ibm_trainer_SA
            ...
            from src.trainer_M1 import ibm_trainer_grad_stat
