    ...
    def __init__(
        ...
        if self.solver == "mlp":
            ...
            self.solid_scheduler = optim.lr_scheduler.ReduceLROnPlateau(
                self.solid_optimizer, "min", patience=500, factor=0.85
            )
        else:
            ...
            for epoch in range(num_epochs):
                    ...
                    if domain_type in self.loss_list:
                        ...
                        for batch_idx, (batch_tensor,) in enumerate(loader):
                            ...
                            if domain_type == "fluid":
                                ...
                                epoch_losses[domain_type] += loss
                                epoch_losses["solid"] += p_normal * physics_weight + loss
                ...
                if (epoch) % self.print_every == 0:
                    ...
                    self.logger.print(
                        ...
                        f"Solid: {epoch_losses['solid'].item():.1e}, "
